...
use gamatecnologias\crudbooster\middlewares\CBAuthAPI;
use Illuminate\Support\Facades\Log;
use Illuminate\Support\Facades\Route;

class CBRouter
{
    private static $cb_namespace = '\gamatecnologias\crudbooster\controllers';
    ...
    private static function userControllerRoute() {
        Route::group([
            'middleware' => ['web', '\gamatecnologias\crudbooster\middlewares\CBBackend'],
